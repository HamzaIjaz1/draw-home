...
exports.PaywallFloatingMenuDemo = void 0;
...
exports.PaywallFloatingMenuDemo = (0, react_1.memo)(() => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(components_1.MainButton, { icon: 'plus', onClick: () => setOpen(negate_1.negate), text: title, variant: open === true ? 'text' : 'contained' }), (0, jsx_runtime_1.jsxs)(components_1.PaywallPopUp, { open: open, onClose: () => setOpen(false), children: [(0, jsx_runtime_1.jsxs)(components_1.PaywallMenuHeader, { children: [(0, jsx_runtime_1.jsx)(components_1.MenuHeader, { text: 'Upgrade', onClose: () => setOpen(false), noHeight: true }), (0, lookup_1.lookup)(period, {
...
//# sourceMappingURL=PaywallFloatingMenuDemo.js.map