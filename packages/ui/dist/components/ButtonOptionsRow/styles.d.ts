export declare const Container: import("@emotion/styled").StyledComponent<import("../BaseRow").BaseRowProps & import("@draw-house/common/dist/utils").WithClassName & import("@mui/system").MUIStyledCommonProps<import("@mui/material").Theme>, {}, {}>;
...
export declare const Options: import("@emotion/styled").StyledComponent<import("@mui/system").MUIStyledCommonProps<import("@mui/material").Theme>, import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, {}>;
type ButtonProps = {
    selected: boolean;
};
