import type { MaterialCategoryPickerProps } from '.';
type ContainerProps = {
    wrap: boolean;
};
export declare const Container: import("@emotion/styled").StyledComponent<import("@mui/system").MUIStyledCommonProps<import("@mui/material").Theme> & ContainerProps, import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, {}>;
type MaterialButtonProps = {
    size: NonNullable<MaterialCategoryPickerProps<number>['size']>;
};
export declare const MaterialButton: import("@emotion/styled").StyledComponent<{
    disabled?: boolean;
...
} & import("@draw-house/common/dist/utils").WithClassName & import("react").RefAttributes<HTMLButtonElement> & import("@mui/system").MUIStyledCommonProps<import("@mui/material").Theme> & MaterialButtonProps, {}, {}>;
type ImageProps = {
    active: boolean;
    squareImages: boolean;
    highlightVariant: NonNullable<MaterialCategoryPickerProps<number>['highlightVariant']>;
    size: NonNullable<MaterialCategoryPickerProps<number>['size']>;
};
export declare const Image: import("@emotion/styled").StyledComponent<import("@mui/system").MUIStyledCommonProps<import("@mui/material").Theme> & ImageProps, import("react").DetailedHTMLProps<import("react").ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>, {}>;
