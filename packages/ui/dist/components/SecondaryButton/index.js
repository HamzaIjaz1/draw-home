...
const Text = (0, material_1.styled)(Typography_1.default) `
  ...
  color: #fff;
`;
const SecondaryButton = ({ className, onClick, text, state = 'default', }) => ((0, jsx_runtime_1.jsx)(StyledButton, { className: className, variant: 'contained', color: 'secondary', disabled: state === 'disabled', onClick: onClick, children: (0, jsx_runtime_1.jsx)(Text, { children: text }) }));
