...
import { BillingButton, MainButton, PaymentPlanCard, PaywallMenuAlert, PaywallMenuCards, PaywallMenuDescription, SlideUpMenu, Tab, Tabs } from '../components';


export const PaywallMenuDemo = memo(() => {
  const title = 'Billing';
